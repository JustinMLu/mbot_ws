...
public:
    ...
    virtual mbot_lcm_msgs::twist2D_t get_command(const mbot_lcm_msgs::pose2D_t& pose, const mbot_lcm_msgs::pose2D_t& target) override
    {
        ...
        // Use dx and dy to convert into distance & angle offset
...
private:
    float pid[3] = {3, 3, 0}; //kp, ka, kb --> DEFAULT: {1.0, 2.5, 0}
...
public:
    ...
    virtual mbot_lcm_msgs::twist2D_t get_command(const mbot_lcm_msgs::pose2D_t& pose, const mbot_lcm_msgs::pose2D_t& target) override
    {
        ...
        // Calculate velocity output for motors
