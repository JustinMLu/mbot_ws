...
int mbot_motor_vel_ctlr(serial_mbot_motor_vel_t vel_cmd, serial_mbot_motor_vel_t vel, serial_mbot_motor_pwm_t *mbot_motor_pwm) {
    ...
    // printf("TGT. VEL - Left: %.2f m/s, Right: %.2f m/s\n", 
    //     vel_cmd.velocity[MOT_L], vel_cmd.velocity[MOT_R]);
    // printf("\n");
    // // Print actual velocities
    // printf("REAL VEL - Left: %.2f m/s, Right: %.2f m/s\n", 
    //     vel.velocity[MOT_L], vel.velocity[MOT_R]);
    // printf("\n");
    // // Print error
    // printf("ERROR... - Left: %.2f m/s, Right: %.2f m/s\n", 
