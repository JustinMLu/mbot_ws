...
class exploration_status_t(object):
    ...
    def _encode_one(self, buf):
        buf.write(struct.pack(">qbb", self.utime, self.state, self.status))
    ...
    def _decode_one(buf):
        ...
        self.utime, self.state, self.status = struct.unpack(">qbb", buf.read(10))
        return self
    _decode_one = staticmethod(_decode_one)

    def _get_hash_recursive(parents):
        if exploration_status_t in parents: return 0
        tmphash = (0x823560c98cbb252e) & 0xffffffffffffffff
