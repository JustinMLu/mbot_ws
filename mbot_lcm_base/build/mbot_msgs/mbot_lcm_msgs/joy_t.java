...
public final class joy_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(mbot_lcm_msgs.joy_t.class))
            return 0L;
 
        classes.add(mbot_lcm_msgs.joy_t.class);
    ...
    public joy_t(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public joy_t(DataInput ins) throws IOException
    {
    ...
    public static mbot_lcm_msgs.joy_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        mbot_lcm_msgs.joy_t o = new mbot_lcm_msgs.joy_t();
    ...
    public mbot_lcm_msgs.joy_t copy()
    {
        mbot_lcm_msgs.joy_t outobj = new mbot_lcm_msgs.joy_t();
