...
#ifndef __mbot_lcm_msgs_occupancy_grid_t_hpp__
#define __mbot_lcm_msgs_occupancy_grid_t_hpp__
...
int occupancy_grid_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int occupancy_grid_t::getEncodedSize() const
{
...
int occupancy_grid_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int occupancy_grid_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int occupancy_grid_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
