...
class particle_t(object):
    ...
    __typenames__ = ["mbot_lcm_msgs.pose2D_t", "mbot_lcm_msgs.pose2D_t", "double"]

    __dimensions__ = [None, None, None]

    def __init__(self):
        self.pose = mbot_lcm_msgs.pose2D_t()
        self.parent_pose = mbot_lcm_msgs.pose2D_t()
        self.weight = 0.0
    ...
    def _encode_one(self, buf):
        assert self.pose._get_packed_fingerprint() == mbot_lcm_msgs.pose2D_t._get_packed_fingerprint()
        self.pose._encode_one(buf)
        assert self.parent_pose._get_packed_fingerprint() == mbot_lcm_msgs.pose2D_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        self = particle_t()
        self.pose = mbot_lcm_msgs.pose2D_t._decode_one(buf)
        self.parent_pose = mbot_lcm_msgs.pose2D_t._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x18016676f01f14e8+ mbot_lcm_msgs.pose2D_t._get_hash_recursive(newparents)+ mbot_lcm_msgs.pose2D_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
