...
class planner_request_t(object):
    ...
    __typenames__ = ["int64_t", "mbot_lcm_msgs.pose2D_t", "boolean"]

    __dimensions__ = [None, None, None]

    def __init__(self):
        self.utime = 0
        self.goal = mbot_lcm_msgs.pose2D_t()
    ...
    def _encode_one(self, buf):
        ...
        assert self.goal._get_packed_fingerprint() == mbot_lcm_msgs.pose2D_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.goal = mbot_lcm_msgs.pose2D_t._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x5942e2809bf67451+ mbot_lcm_msgs.pose2D_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
